            ...
            dbc.Row([
                ...
                dbc.Card([
                    dbc.Container([
                        ...
                        dbc.CardBody([
                            dcc.Slider(id='F5', value=100000, min=100000, max=500000, step=1, marks=None,
                                       className="F5slider")])
                    ], className='container-fluid')
...
@app.callback(
    ...
    [Input('dropdown', 'value'),
     ...
     Input('Pr1', 'value')])
# create our callback function
def update_figure(selected_year, selected_F5,selected_P2, selected_F2, selected_S1, selected_Pr1):
    # (year,p2,p3,p4,f2,f4,f5,f6,s1,s2,s3,s5,s6,s8,pr1,ar1,ar2,ar3)
    df = func(selected_year, selected_P2, 0, 0, selected_F2, 0, selected_F5, 0, selected_S1, 0, 0, 0, 0, 0, selected_Pr1, 0, 0, 0)
...
@app.callback(Output('textarea5', 'value'), [Input('F5', 'value')])
