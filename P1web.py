...
app.layout = dbc.Container([
    ...
    dbc.Row([
        html.Div([
            dcc.Dropdown(
                ['2023', '2024', '2025', '2026', '2027', '2028', '2029', '2030'], '2023',searchable=False, clearable=False,
                id='dropdown',
...
def update_figure(selected_P2, selected_F2, selected_S1, selected_Pr1):
    ...
    fig = px.bar(data_frame=df, x='год', y='значение', text_auto='.4s', template='plotly', title='P1')
    fig.update_layout(
        plot_bgcolor='#515151',
...
def update_figure_p3_с(selected_year, selected_P2, selected_F2, selected_S1, selected_Pr1):
    ...
    fig = px.bar(data_frame=df, x='год', y='значение', color='год', text_auto='.0s', template='plotly', title='P3_c')
    fig.update_layout(xaxis_title=None,
                      yaxis_title=None,
                      plot_bgcolor='#515151',
                      paper_bgcolor='#515151', font_color="#D4D4D4")
