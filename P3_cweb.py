                ...
                dbc.Row([
                    ...
                    dbc.Card([
                        dbc.Container([
                            ...
                            dbc.CardBody([
                                dcc.Slider(id='Ar3', value=1, min=1, max=100, step=1, marks=None,
                                           className="slider")])
                        ], className='container-fluid')
...
def update_figure(selected_Ar3, selected_P2, selected_F2, selected_S1, selected_Pr1):
    ...
    fig = px.bar(data_frame=df, x='год', y='значение', text_auto='.4s', template='plotly', title='P3_c')
    fig.update_layout(
        plot_bgcolor='#515151',
