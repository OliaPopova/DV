...
@app.callback(
    ...
    [Input('dropdown', 'value'),
     ...
     Input('P2', 'value')])
# create our callback function
def update_figure(selected_year, selected_Pr1, selected_S1, selected_S2, selected_S3, selected_F2, selected_P2):
    # (year,p2,p3,p4,f2,f4,f5,f6,s1,s2,s3,s5,s6,s8,pr1,ar1,ar2,ar3)
    df = func(selected_year, selected_P2,0, 0, selected_F2, 0, 0, 0, selected_S1, selected_S2, selected_S3, 0, 0, 0, selected_Pr1, 0, 0, 0)
